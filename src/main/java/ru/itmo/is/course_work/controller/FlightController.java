...
public class FlightController {
  ...
  @GetMapping("select")
  @Operation(
      summary = "Подобрать подходящие рейсы в зависимости от характеристик текущего пользователя")
  public ResponseEntity<List<FlightDto>> selectAvailableFlightsForCurrentUser(
      @RequestParam Long departurePlanetId, @RequestParam Long arrivalPlanetId) {
