...
public class FlightScheduleController {
  ...
  @GetMapping
  @Operation(summary = "Возвращает список всех расписаний полетов")
  ...
  @GetMapping("/{id}")
  @Operation(summary = "Возвращает расписание полета по указанному идентификатору")
  ...
  @PostMapping
  @Operation(summary = "Создает новое расписание полета")
  public ResponseEntity<FlightScheduleDto> createFlightSchedule(
      @RequestBody @Valid FlightScheduleRequest request) {
  ...
  @Operation(
      summary =
          "Обновляет расписание полета с указанным идентификатором на основе переданных данных")
  public ResponseEntity<FlightScheduleDto> updateSchedule(
      @PathVariable Long id, @RequestBody @Valid FlightScheduleRequest request) {
  ...
  @DeleteMapping("/{id}")
  @Operation(summary = "Удаляет расписание полета с указанным идентификатором")
  ...
  public ResponseEntity<List<FlightScheduleDto>> assignFlight(
      @PathVariable Long scheduleId, @RequestBody @Valid AssignFlightToScheduleDto dto) {
