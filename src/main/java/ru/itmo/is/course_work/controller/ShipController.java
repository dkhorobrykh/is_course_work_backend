...
public class ShipController {
  ...
  @PostMapping("/add")
  @Operation(summary = "Добавить новый корабль.")
  ...
  @Operation(summary = "Обновление условий на борту корабля.")
  public ResponseEntity<String> updateShipConditions(
    ...
    boolean updated =
        shipService.updateShipConditions(id, temperature, atmosphereType, radiationProtectionLevel);
    ...
    if (updated) {
      ...
      return ResponseEntity.status(HttpStatus.BAD_REQUEST)
          .body(
              "Не удалось обновить условия на борту корабля. Проверьте соответствие условий для груза и пассажиров.");
    }
  }
  ...
  public ResponseEntity<ShipDto> updateShip(
      @PathVariable Long shipId, @RequestBody ShipDto shipDto) {
