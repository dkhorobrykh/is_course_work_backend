...
@Tag(name = "Insurance Controller", description = "Контроллер программ страхования")
public class InsuranceController {
  ...
  public ResponseEntity<List<InsuranceIssuedDto>> getAllIssuedInsuranceByFlightIdAndUserId(
      @PathVariable Long flightId, @PathVariable Long userId) {
  ...
  public ResponseEntity<InsuranceIssuedDto> addInsurance(
      @RequestBody @Valid InsuranceIssueRequestDto dto) {
  ...
  public ResponseEntity<List<InsuranceProgramDto>> getAvailableInsuranceProgramsForFlight(
      @PathVariable Long flightId) {
