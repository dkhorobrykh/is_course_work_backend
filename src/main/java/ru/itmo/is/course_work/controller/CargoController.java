...
@Tag(name = "Cargo controller", description = "Контроллер для взаимодействия с системой грузов")
public class CargoController {
  ...
  @GetMapping("sender")
  @Operation(
      summary = "Получить список грузов, в которых текущий пользователь числится отправителем")
  ...
  @Operation(
      summary = "Получить список грузов, в которых текущий пользователь числится получаетелем")
