...
@Mapper(
    ...
    uses = {FlightMapper.class, PlanetMapper.class, PlanetMapper.class, ScheduleStatusMapper.class},
    imports = {FlightScheduleService.class, FlightMapper.class})
public abstract class FlightScheduleMapper {
  @Autowired protected FlightScheduleService flightScheduleService;

  @Autowired protected FlightMapper flightMapper;

  public abstract FlightSchedule toEntity(FlightScheduleDto flightScheduleDto);

  @Mapping(
      expression =
          "java(flightMapper.toDto(flightScheduleService.getFlightByScheduleId(flightSchedule.getId()"
              + ")))",
      target = "flight")
  ...
  public abstract FlightSchedule partialUpdate(
      FlightScheduleDto flightScheduleDto, @MappingTarget FlightSchedule flightSchedule);
}
