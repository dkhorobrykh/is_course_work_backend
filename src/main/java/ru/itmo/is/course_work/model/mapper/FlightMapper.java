...
@Mapper(
    ...
    uses = {
      ShipMapper.class,
      FlightStatusMapper.class,
      WorkerMapper.class,
      PlanetMapper.class,
      GalaxyMapper.class
    })
public abstract class FlightMapper {
  @Autowired public FlightScheduleService flightScheduleService;
  @Autowired public PlanetMapper planetMapper;
  ...
  //        "flightSchedule")
  //    @Mapping(expression =
  // "java(planetMapper.toDto(flightScheduleService.getByFlightId(flightSchedule.getFlight()" +
  ...
  // planetMapper.toDto(flightScheduleService.getByFlightId(flightSchedule.getFlight().getId()).getPlanetDeparture());
  //        PlanetDto planetArrival =
  // planetMapper.toDto(flightScheduleService.getByFlightId(flightSchedule.getFlight().getId()).getPlanetArrival());
  //        FlightDto flight = null;
  //
  //        FlightScheduleDto flightScheduleDto = new FlightScheduleDto( id, planetDeparture,
  // planetArrival, departureDatetime, arrivalDatetime, scheduleStatus, flight );
  //
  //        return flightScheduleDto;
  //    }
  //
  //    public abstract ScheduleStatusDto scheduleStatusToScheduleStatusDto(ScheduleStatus
  // scheduleStatus);
