...
public class FlightService {
  ...
  public Flight findSuitableFlightForCargo(Cargo cargo) {
    ...
    for (var flight : getAllAvailableFlights()) {
      ...
      if (conditions.getHabitat() != null
          && !ship.getHabitat().getId().equals(conditions.getHabitat().getId())) continue;

      if (conditions.getAirType() != null
          && !ship.getAirType().getId().equals(conditions.getAirType().getId())) continue;
  ...
  public List<Flight> selectAvailableFlights(Long departurePlanetId, Long arrivalPlanetId) {
    ...
    return flightRepository.findAllAvailableForUser(
        departure.getId(),
        arrival.getId(),
        type == null ? null : type.getAirType().getId(),
        type == null ? null : type.getHabitat().getId(),
        type == null ? null : type.getTemperatureType().getId(),
        neededStatusNames);
  }
  ...
  public Flight changeStatus(Long flightId) {
    ...
    var newStatus =
        flightStatusService.getFlightStatusByName(
            flightStatuses.get(flight.getFlightStatus().getName()));
  ...
  public Flight changeCargoStatus(Long flightId) {
    ...
    var newStatus =
        cargoStatusService.getCargoStatusByName(
            cargoStatuses.get(flight.getCargoStatus().getName()));
